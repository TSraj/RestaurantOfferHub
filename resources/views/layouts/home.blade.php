...
<html lang="en">
  <head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('fontend/img/favicon.ico') }}" type="image/x-icon">
    ...
    <!-- Date Picker -->
    <link rel="stylesheet" type="text/css" href="{{ asset('fontend/css/bootstrap-datepicker.css') }}">   
     <!-- Gallery Lightbox -->
    <link href="{{ asset('fontend/css/magnific-popup.css') }}" rel="stylesheet"> 
    <!-- Theme color -->
    <link id="switcher" href="{{ asset('fontend/css/theme-color/default-theme.css') }}" rel="stylesheet">     
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->       
           ...
           <!--  Text based logo  -->
          <a class="navbar-brand" href="home.blade.php">Restaurant Offer<span> Hub</span></a> 
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right mu-main-nav">
            ...
            <li><a href="#mu-contact">Log Out</a></li> 
          </ul>                            
        </div><!--/.nav-collapse -->       
      </div>          
    </nav> 
    ...
    <div class="mu-slider-area"> 
      ...
      <div class="mu-top-slider">
        ...
        <div class="mu-top-slider-single">
          <img src="{{ asset('fontend/img/slider/1.jpeg') }}" alt="img">
          <!-- Top slider content -->
        ...
        <!-- / Top slider single slide -->    
         ...
         <!-- Top slider single slide -->
        <div class="mu-top-slider-single">
          <img src="{{ asset('fontend/img/slider/2.jpeg') }}" alt="img">
          <!-- Top slider content -->
          <div class="mu-top-slider-content">
        ...
        <!-- Top slider single slide -->
        <div class="mu-top-slider-single">
          <img src="{{ asset('fontend/img/slider/3.jpeg') }}" alt="img">
          <!-- Top slider content -->
          <div class="mu-top-slider-content">
...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
  ...
  <!-- Slick slider -->
  <script type="text/javascript" src="{{ asset('fontend/js/slick.js') }}"></script>
  <!-- Counter -->
  <script type="text/javascript" src="{{ asset('fontend/js/simple-animated-counter.js') }}"></script>
  <!-- Gallery Lightbox -->
  <script type="text/javascript" src="{{ asset('fontend/js/jquery.magnific-popup.min.js') }}"></script>
  <!-- Date Picker -->
  <script type="text/javascript" src="{{ asset('fontend/js/bootstrap-datepicker.js') }}"></script> 
  <!-- Ajax contact form  -->
  <script type="text/javascript" src="{{ asset('fontend//js/app.js') }}"></script>
